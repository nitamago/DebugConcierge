...
public class BaseVisitor extends ASTVisitor {
	...
	public void visit(CompilationUnit q_unit, CompilationUnit a_unit) throws NullPointerException {
		if (q_unit == null || a_unit == null) {
			return;
		}
	...
	public ArrayList<TupleUtil.Triple<Integer, Integer, String>> get_q_anchor(){
		return this.raw_q_anchor;
	}
	
	public ArrayList<TupleUtil.Triple<Integer, Integer, String>> get_a_anchor(){
